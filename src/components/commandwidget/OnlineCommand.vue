<template>
  ...
  <div class="card flex flex-col items-center justify-center overflow-hidden">
...
<script>
import { useRobot, useLogicUI, useRegionalTimer } from "../../stores/store";
