        ...
        >
          ...
          <section>
            <div
              ...
              class="cursor-pointer rounded-lg border border-gray-200 bg-white py-1 px-3 text-lg font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200"
            >
              Control Box
            </div>
            <div>
